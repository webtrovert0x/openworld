...
export default function CollectionMarketplacePage() {
      ...
      <div className="panel rounded-xl p-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-mono">
        ...
        <form onSubmit={(e) => {
          ...
          if (customAddressInput.startsWith('0x') && customAddressInput.length === 42) {
            window.location.href = `/collection/${customAddressInput}`;
          }
        }} className="flex items-center gap-2 w-full sm:w-auto flex-1 max-w-xl">
          <input
            type="text"
